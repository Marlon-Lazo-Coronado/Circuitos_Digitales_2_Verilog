...
(* src = "Mux_Conductual_2x1_2bits.v:1" *)
module Mux_Conductual_2x1_2bits(data_out, valid_out1, clok, valid1, valid2, reset_L, selector, data_in0, data_in1);
  (* src = "Mux_Conductual_2x1_2bits.v:12" *)
  wire [1:0] _00_;
  (* src = "Mux_Conductual_2x1_2bits.v:12" *)
  wire _01_;
  wire _02_;
  ...
  wire _20_;
  wire _21_;
  (* src = "Mux_Conductual_2x1_2bits.v:4" *)
  input clok;
  (* src = "Mux_Conductual_2x1_2bits.v:9" *)
  input [1:0] data_in0;
  (* src = "Mux_Conductual_2x1_2bits.v:10" *)
  input [1:0] data_in1;
  (* src = "Mux_Conductual_2x1_2bits.v:2" *)
  output [1:0] data_out;
  (* src = "Mux_Conductual_2x1_2bits.v:7" *)
  input reset_L;
  (* src = "Mux_Conductual_2x1_2bits.v:8" *)
  input selector;
  (* src = "Mux_Conductual_2x1_2bits.v:5" *)
  input valid1;
  (* src = "Mux_Conductual_2x1_2bits.v:6" *)
  input valid2;
  (* src = "Mux_Conductual_2x1_2bits.v:3" *)
  output valid_out1;
  NAND _22_ (
    .A(data_in1[1]),
    .B(_06_),
...
module Mux_Conductual_2x1_4bits_Estruc(out2_Estruc, valid_out2_Estruc, clok, valid1, valid2, reset_L, selector, bus1, bus2);
  ...
  Mux_Conductual_2x1_2bits xy (
    .clok(clok),
    .data_in0(bus1[1:0]),
    .data_in1(bus2[1:0]),
    .data_out(out2_Estruc[1:0]),
    .reset_L(reset_L),
    .selector(selector),
    .valid1(valid1),
    .valid2(valid2),
    .valid_out1(valid_out2_Estruc)
  );
  (* module_not_derived = 32'd1 *)
  (* src = "Mux_Conductual_2x1_4bits_Estruc.v:24" *)
  Mux_Conductual_2x1_2bits yz (
    .clok(clok),
    .data_in0(bus1[3:2]),
    .data_in1(bus2[3:2]),
    .data_out(out2_Estruc[3:2]),
    .reset_L(reset_L),
    .selector(selector),
    .valid1(valid1),
    .valid2(valid2),
